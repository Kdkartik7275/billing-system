...
class GetUnsyncedBillsUsecase
    implements UseCaseWithoutParams<List<BillEntity>> {
  final BillRepository repository;

  GetUnsyncedBillsUsecase({required this.repository});
  @override
  ResultFuture<List<BillEntity>> call() async {
    return await repository.getUnsyncedBills();
  }
}
