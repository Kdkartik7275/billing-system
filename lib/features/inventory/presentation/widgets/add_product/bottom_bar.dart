  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      final deleteButton = OutlinedButton(
        onPressed: controller.isSaving.value ? null : controller.deleteProduct,
        style: OutlinedButton.styleFrom(
        ...
        child: Text(
          ...
          style: Theme.of(
            context,
          ).textTheme.bodyMedium!.copyWith(color: const Color(0xFFE5484D)),
        ),
      );
      ...
      final saveButton = ElevatedButton(
        ...
        child: controller.isSaving.value
            ...
            : Text(
                controller.isEditMode ? 'Save Changes' : 'Add Product',
      ...
      return Row(
        children: [
          if (!controller.isSaving.value) Expanded(child: cancelButton),

          if (!controller.isSaving.value) const SizedBox(width: 10),
