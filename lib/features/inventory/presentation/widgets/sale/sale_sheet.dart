...
import 'package:billing_system/features/inventory/presentation/controller/sale_controller.dart';
...
Future<bool?> showAddSaleSheet(
  ...
  return showModalBottomSheet<bool>(
    ...
    builder: (_) => FractionallySizedBox(
      heightFactor: 0.9,
      child: _AddSaleSheet(product: product),
    ),
  );
}
...
class _AddSaleSheet extends StatefulWidget {
  ...
  const _AddSaleSheet({required this.product});
...
class _AddSaleSheetState extends State<_AddSaleSheet> {
  late final AddSaleController controller;
  late final String tag;

  @override
  void initState() {
    super.initState();
    tag = 'sale_${widget.product.id}_${DateTime.now().microsecondsSinceEpoch}';
    controller = Get.put(
      AddSaleController(product: widget.product, sellStockUsecase: sl()),
      tag: tag,
    );
  }
  ...
  @override
  void dispose() {
    Get.delete<AddSaleController>(tag: tag);
    super.dispose();
  }
        ...
        children: [
          ...
          Padding(
            ...
            child: DialogHeaderBar(
              ...
              title: 'Add Sale',
              subtitle: 'Record a manual sale for this product',
              onClose: () => Get.back(),
            ),
          ),
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  LabeledTextField(
                    label: 'Reason',
                    hintText: 'e.g. Walk-in sale, phone order...',
